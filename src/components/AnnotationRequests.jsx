...
export default function QuickStart({ isServerInfo }) {
  ...
  async function make_annotation_request() {
    ...
    ann.set("requester_wallet_address",currentUser.attributes.ethAddress)
      ...
      <div>
        ...
        <div className="container mx-auto">
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            ...
            <input type="text" id="username-success" className="flex justify-center items-center col-span-2 border  text-sm rounded-lg  block w-full p-2.5 dark:bg-green-100 dark:border-green-400" 
            placeholder="Maximum Price you'd be willing to pay (in ETH)"
