                                    ...
                                    <div key={index} className="bg-white rounded-lg p-3  flex flex-col justify-center items-center md:items-start shadow-lg mb-4">
                                        <div className="flex flex-row justify-center mr-2">
                                            ...
                                            <div className="px-4 h-4">
                                                <button className="font-bold py-2 px-4 w-full bg-purple-400 text-lg text-white shadow-md rounded-lg " onClick={() => pay(post.poster_wallet_address, index)}>Pay</button>
                                            </div>
